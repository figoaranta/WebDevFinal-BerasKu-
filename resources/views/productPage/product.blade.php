  			...
  			<div class=""></div>
   			<div class="col-sm-4" style="border-style: solid">
    			...
    			<div style="margin-bottom: 5rem" class="text-center">
            		<a onclick="passValue()" href="/public/productPage/addProduct/1" class="btn btn-primary">Buy Now!</a>
          		</div>
   			</div>
   			<div class="col-sm-4" style="border-style: solid">
    			...
    			<div style="margin-bottom: 5rem" class="text-center">
            		<a onclick="passValue()" href="/public/productPage/addProduct/2" class="btn btn-primary">Buy Now!</a>
          		</div>
   			</div>
  		</div>
	</div>
